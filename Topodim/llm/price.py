from Topodim.utils.globals import Cost, PromptTokens, CompletionTokens, Tokenizer, Deepseek_Tokenizer
import tiktoken
...
def cost_count_deepseek(prompt, response, model):
    ...
    tokenizer = Deepseek_Tokenizer.instance().tokenizer
